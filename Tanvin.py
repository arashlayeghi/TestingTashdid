...
# Added For Testing Tanvin
diacritics_subset = set(['ٌ', 'ٍ', 'ً', SAKEN_CHAR])
...
for iteration in range(1, 31):
    ...
    for diversity in [1.0]:
        ...
        wrong_tanvin_middle_of_word = 0.0
        ...
        for i in range(maxlen - 1, testing_data_length):
            ...
            # added for Testing Tanvin
            if next_diacritic != SAKEN_CHAR:
                if testing_data[i + 1] in alphabet:
                        wrong_tanvin_middle_of_word += 1.0
        ...
        statistics_result += '\nwrong_tanvin_middle_of_word: ' + str(wrong_tanvin_middle_of_word)
